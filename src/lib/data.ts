...
export const phases: Phase[] = [
  {
    ...
    objective: "Pasar de operación improvisada a negocio profesional con control real.",
    tasks: [
      "Estandarizar recetas del menú (referencia en tu app operativa)",
      "Definir gramajes por producto",
      ...
      "Identificar productos estrella y débiles",
      "Ajustar precios estratégicamente",
      "Reducir mermas y fugas"
    ],
  ...
  },
  {
    ...
    objective: "Lograr una experiencia consistente y una marca reconocible.",
    tasks: [
      ...
      "Mejorar experiencia de servicio",
      ...
      "Diferenciarse de competencia local"
    ],
  ...
  },
  {
    ...
    objective: "Controlar el negocio con sistemas y reportes, no solo intuición.",
    tasks: [
      "Implementar POS",
      "Dashboard de ventas",
  ...
  },
  {
    ...
    objective: "Mantener rentabilidad constante y validar operación multisucursal.",
    tasks: [
      "Operación rentable constante",
      "Incrementar ticket promedio",
      "Optimizar costos de insumos",
      "Crear combos rentables",
      "Delivery rentable",
      "Dark kitchen opcional",
      "Abrir segunda sucursal propia",
      "Validar operación multisucursal",
      "Estandarizar supervisión remota",
      "Formar gerentes operativos"
    ],
  ...
  },
  {
    ...
    objective: "Crear estructura legal, operativa y financiera para franquiciar con control.",
    tasks: [
      "Registrar marca legalmente",
      "Proteger nombre comercial",
  ...
  },
  {
    ...
    objective: "Lanzar franquicias de forma controlada y medible.",
    tasks: [
      "Crear unidad piloto modelo",
      "Documentar métricas reales",
      "Vender primeras franquicias controladas",
  ...
  },
  {
    ...
    objective: "Consolidar estructura corporativa para escalar a gran nivel.",
    tasks: [
      ...
      "Área corporativa administrativa",
      "Dirección financiera profesional",
      "Dirección operativa nacional",
      "Consejo estratégico",
      "Venta parcial a inversionistas o expansión masiva"
    ],
